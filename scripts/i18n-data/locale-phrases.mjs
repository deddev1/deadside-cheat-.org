...
export const localePhrases = {
	es: {
		...
		metaDesc: (topicName) =>
			`${topicName}: ESP wallhack, radar hack y Aimbot para Deadside. Entrega digital instantánea y mantenimiento anti-cheat incluido.`,
		legalCollect:
	...
	fr: {
		...
		metaDesc: (topicName) =>
			`${topicName} : ESP wallhack, radar hack et Aimbot pour Deadside. Livraison numérique instantanée et maintenance anti-cheat incluse.`,
		legalCollect:
	...
	de: {
		...
		maintenance: 'Bad Pixel-Anti-Cheat-Wartung inklusive',
		...
		metaDesc: (topicName) =>
			`${topicName}: ESP wallhack, radar hack und Aimbot für Deadside. Sofortige digitale Lieferung und Bad Pixel-Anti-Cheat-Wartung inklusive.`,
		legalCollect:
