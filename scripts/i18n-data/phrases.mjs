...
const LOCALE_CORE = {
	...
	pt: {
		buy: 'Comprar Deadside Cheats', win: 'PC Windows',
	...
	it: {
		buy: 'Acquista Deadside Cheats', win: 'PC Windows',
	...
	nl: {
		buy: 'Deadside Cheats kopen', win: 'Windows PC',
	...
	pl: {
		buy: 'Kup Deadside Cheats', win: 'PC Windows',
	...
	ru: {
		buy: 'Купить Deadside Cheats', win: 'Windows PC',
	...
	tr: {
		buy: 'Deadside Cheats satın al', win: 'Windows PC',
	...
	ar: {
		buy: 'اشترِ Deadside Cheats', win: 'Windows PC',
	...
	ja: {
		buy: 'Deadside Cheatsを購入', win: 'Windows PC',
	...
	ko: {
		buy: 'Deadside Cheats 구매', win: 'Windows PC',
	...
	zh: {
		buy: '购买 Deadside Cheats', win: 'Windows PC',
	...
	hi: {
		buy: 'Deadside Cheats खरीदें', win: 'Windows PC',
	...
	id: {
		buy: 'Beli Deadside Cheats', win: 'PC Windows',
	...
	th: {
		buy: 'ซื้อ Deadside Cheats', win: 'Windows PC',
	...
	vi: {
		buy: 'Mua Deadside Cheats', win: 'PC Windows',
	...
	uk: {
		buy: 'Купити Deadside Cheats', win: 'Windows PC',
	...
	cs: {
		buy: 'Koupit Deadside Cheats', win: 'Windows PC',
	...
	ro: {
		buy: 'Cumpără Deadside Cheats', win: 'PC Windows',
	...
	sv: {
		buy: 'Köp Deadside Cheats', win: 'Windows PC',
