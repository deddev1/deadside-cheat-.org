...
const sources = [
	...
	},
	{
		...
		metaDescription:
			'How Bad Pixel anti-cheat relates to Deadside on Windows PC — what it monitors, why builds break after patches, and how to read official update notes before you play.',
		h1: 'Deadside Anti-Cheat on PC: A Practical Overview',
		intro:
			'If you use overlays or third-party tools on Deadside, you need a realistic picture of anti-cheat — not hype. This article explains what Bad Pixel maintenance means for everyday raids and where to check status after updates.',
		...
		sections: [
			{
				...
				paragraphs: [
					`Deadside on Windows PC runs with protection operated by ${EXT.epic}. That stack watches for known cheat signatures, suspicious memory access, and common loader patterns — the same class of risk that affects any modded client.`,
	...
	},
	{
		...
		metaDescription:
			'Tune Deadside ESP distance and clutter so player boxes stay readable in loot runs and open-world PvP — without turning your screen into noise.',
		h1: 'Deadside ESP Distance: Keep Overlays Readable',
		intro:
			'ESP only helps when you can parse it in two seconds. Deadside fights move fast across fields, compounds, and tree lines — distance filters and category toggles matter more than max range.',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					`When ${EXT.deadside} changes lighting or foliage density, revisit distance presets on the next session.`,
				],
			},
			{
				h2: 'FAQ',
	...
	},
	{
		...
		metaDescription:
			'Deadside night raids punish weak visibility. Adjust in-game gamma, monitor settings, and ESP contrast so players and loot stay visible after dark.',
		h1: 'Deadside Night Raids: See Contacts Without Eye Strain',
		intro:
			'Night and dusk servers change how you read silhouettes, tracers, and loot glints. Small display tweaks plus calmer ESP colors often beat cranking every toggle to max.',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					`Check ${EXT.status} when patches touch lighting or weather FX.`,
				],
			},
			{
				h2: 'FAQ',
	...
	},
	{
		...
		metaDescription:
			'Patch day on Deadside PC: verify game files, read Bad Pixel notes, confirm cheat build status, and avoid queuing on outdated loaders.',
		h1: 'Deadside Patch Day: Checklist Before You Queue',
		intro:
			'Major Deadside updates shuffle weapons, map hotspots, and anti-cheat rules. A short patch-day routine saves hours of ban scares, broken loaders, and wasted kits.',
		...
		sections: [
			{
				...
				paragraphs: [
					`Start with ${EXT.patchNotes} and ${EXT.deadside} news. Note weapon changes, loot tweaks, and any anti-cheat mention before you open a loader.`,
	...
	},
	{
		...
		metaDescription:
			'Use Deadside vehicle ESP to spot cars and convoys on highways without drowning in loot icons — filters, distance, and fight timing.',
		h1: 'Deadside Vehicle ESP Without Screen Clutter',
		intro:
			'Vehicles rotate loot fast on Deadside highways but they also draw third parties. Vehicle ESP helps you see approaching cars early — if you filter loot noise and distance correctly.',
	...
	},
	{
		...
		metaDescription:
			'Tune Deadside 2D radar scale and distance filters so flanks show up during looting without constant edge alerts.',
		h1: 'Deadside Radar Filters That Match Your Playstyle',
		intro:
			'Radar is for angles ESP does not cover — but an oversized ring or zero filtering feels like constant panic. These filter habits work for solo farmers and squad pushes alike.',
	...
	},
	{
		...
		metaDescription:
			'Keep Deadside FPS stable with ESP and radar enabled — GPU load, overlay count, and in-game graphics presets that help Windows PC players.',
		h1: 'Deadside Overlays and FPS: Practical Tweaks',
		intro:
			'Deadside firefights punish stutter. Extra overlays add GPU work — trimming categories and killing duplicate capture software often matters more than buying hardware.',
	...
	},
	{
		...
		metaDescription:
			'Prioritize Deadside loot ESP categories — weapons, meds, armor, and stashes — so farming routes stay fast without blocking player awareness.',
		h1: 'Deadside Loot ESP: Start With These Toggles',
		intro:
			'Loot ESP can speed up routes or bury player threats under icons. Enable high-value categories first, then add containers only for the areas you actually farm.',
	...
	},
	{
		...
		metaDescription:
			'Solo and squad Deadside raids need different ESP and radar habits — comms, range, and who watches which angle on PC.',
		h1: 'Deadside Solo vs Squad: Different Overlay Habits',
		intro:
			'The same cheat profile rarely fits solo loot runs and four-man pushes. Adjust range, radar scale, and callout discipline instead of copying a streamer’s config.',
	...
	},
	{
		...
		metaDescription:
			'Bookmark official Deadside patch notes on Steam and Bad Pixel channels — verify wipes, weapons, and anti-cheat posts before you trust rumor threads.',
		h1: 'Official Deadside Patch Notes: Sources That Matter',
		intro:
			'Reddit threads and Discord leaks miss context. These official sources tell you what actually changed in Deadside before you adjust loadouts or software.',
		...
		sections: [
			{
				...
				paragraphs: [
					`${EXT.patchNotes} is the fastest PC changelog most players see. Match build numbers with your Steam client before blaming loaders.`,
				],
			},
			{
				h2: 'Publisher and community hubs',
				paragraphs: [
					`${EXT.deadside} posts broader announcements. ${EXT.wiki} and ${EXT.forums} help with mechanics wording when patch notes are vague.`,
				],
			},
			{
...
const ENLISTED_BLOG_IDS = new Set([
	...
	'deadside-anticheat-basics',
	'deadside-esp-distance',
	'deadside-night-raids',
	'deadside-patch-day-checklist',
	'deadside-vehicle-esp',
	'deadside-radar-filters',
	'deadside-overlay-fps',
	'deadside-loot-esp-toggles',
	'deadside-solo-vs-squad',
	'deadside-patch-sources',
]);
