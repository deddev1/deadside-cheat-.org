...
const REPLACEMENTS = [
	...
	['ricochet', 'eac'],
	['Verdansk, Urzikstan, and Rebirth Island', 'Deadside missions, large-scale battles, and loot runs lobbies'],
	['Verdansk, Urzikstan and Rebirth Island', 'Deadside missions, large-scale battles and loot runs lobbies'],
	['Verdansk, Urzikstan, et Rebirth Island', 'Deadside missions, large-scale battles et lobbies compétitifs'],
	['Verdansk, Urzikstan e Rebirth Island', 'Deadside missions, large-scale battles e lobbies competitivi'],
	['Verdansk, Urzikstan und Rebirth Island', 'Deadside missions, large-scale battles und loot runs-Lobbys'],
	...
	['Operator', 'Player'],
	['UAV', 'supply drop'],
	['Resurgence and loot runs', 'large-scale battles and loot runs'],
	['BR and Resurgence', 'BR and large-scale battles'],
	['BR & Resurgence', 'BR & large-scale battles'],
	['loadout drops', 'loot chests'],
	['loadout drop', 'loot chest'],
	['contracts', 'chests'],
	['contract', 'chest'],
	['Al Mazrah', 'Deadside missions'],
