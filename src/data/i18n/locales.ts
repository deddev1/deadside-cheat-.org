...
const blogUiContent = {
	blogTitle: 'Deadside Cheats Guides | ESP, Aimbot & Anti-Cheat',
	blogDescription:
		'Deadside cheats guides for ESP, aimbot, wallhack, undetected status, vendor comparisons, setup, and anti-cheat maintenance after Bad Pixel patches.',
	blogH1: 'Deadside cheats guides',
	blogIntro:
		'Cheats buying guides, ESP and aimbot setup notes, undetected anti-cheat checklists, and honest vendor comparisons for Deadside Cheats on Windows PC.',
} as const;
...
> = {
	...
	id: {
		...
		updated: 'Diperbarui',
		relatedPosts: 'Panduan Deadside terkait',
